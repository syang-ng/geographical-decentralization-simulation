...
export function Header() {
  return (
    <header className="border-b border-border-subtle overflow-hidden">
        ...
        <div className="flex items-start justify-between gap-4 relative z-10">
          <div className="min-w-0">
            <div className="flex items-center gap-2.5">
              <div className="w-2.5 h-2.5 shrink-0 rounded-full bg-accent dot-pulse" />
              <h1 className="text-lg font-semibold text-text-primary font-serif truncate">
            ...
            <p className="text-[10px] text-text-faint mt-0.5 ml-5 font-mono tracking-wide">
